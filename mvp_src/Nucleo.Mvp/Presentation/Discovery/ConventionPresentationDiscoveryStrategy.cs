...
namespace Nucleo.Presentation.Discovery
{
	...
	public class ConventionPresentationDiscoveryStrategy : IPresentationDiscoveryStrategy
	{
		...
		public virtual Type FindPresenterType(PresenterDiscoveryOptions options)
		{
		...
		protected virtual Type FindPresenterTypeInAppDomain(string presenterType, PresenterDiscoveryOptions options)
		{
