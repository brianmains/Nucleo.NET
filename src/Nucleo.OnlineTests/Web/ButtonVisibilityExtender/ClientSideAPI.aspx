<%@ Page Title="" Language="C#" MasterPageFile="~/Web/test.master" AutoEventWireup="true" CodeBehind="ClientSideAPI.aspx.cs" Inherits="Nucleo.Web.ButtonVisibilityExtender.ClientSideAPI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CodeSample" runat="server">
	...
	<n:ButtonVisibilityExtender ID="extControl" runat="server" TargetControlID="btnControl"
