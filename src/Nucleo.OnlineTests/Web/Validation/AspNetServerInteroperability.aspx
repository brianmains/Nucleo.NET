<%@ Page Title="" Language="C#" MasterPageFile="~/Web/test.master" AutoEventWireup="true" CodeBehind="AspNetServerInteroperability.aspx.cs" Inherits="Nucleo.Web.Validation.AspNetServerInteroperability" %>
	...
	<div>
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtFirstName"
				ErrorMessage="Please enter a first name." EnableClientScript="false">*</asp:RequiredFieldValidator>
		</div>
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="txtLastName"
				ErrorMessage="Please enter a last name." EnableClientScript="false">*</asp:RequiredFieldValidator>
		</div>
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvState" runat="server" ControlToValidate="txtState"
				ErrorMessage="Please enter a state." EnableClientScript="false">*</asp:RequiredFieldValidator>
	...
	<div>
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvFirstName2" runat="server" ControlToValidate="txtFirstName2"
				ErrorMessage="Please enter a first name." ValidationGroup="Second"
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvLastName2" runat="server" ControlToValidate="txtLastName2"
				ErrorMessage="Please enter a last name." ValidationGroup="Second"
				 EnableClientScript="false">*</asp:RequiredFieldValidator>
		</div>
		...
		<div>
			...
			<asp:RequiredFieldValidator ID="rfvState2" runat="server" ControlToValidate="txtState2"
				ErrorMessage="Please enter a state." ValidationGroup="Second"
				 EnableClientScript="false">*</asp:RequiredFieldValidator>
