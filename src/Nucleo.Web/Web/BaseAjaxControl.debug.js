...
Nucleo.Web.BaseAjaxControl = function(associatedElement) {
	Nucleo.Web.BaseAjaxControl.initializeBase(this, [associatedElement]);
...
Nucleo.Web.BaseAjaxControl.prototype =
{
	...
	_getInnerElement: function (partialID) {
		return $get(this._getInnerElementID(partialID));
	},

	_getInnerElementID: function (partialID) {
		return this.get_element().id + "_" + partialID;
	},
	...
	initialize: function () {
		Nucleo.Web.BaseAjaxControl.callBaseMethod(this, "initialize");
		...
		var unloadHandler = Function.createDelegate(this, function () {
			if (this._clientState != null)
		...
		for (var i = 0, len = forms.length; i < len; i++)
			$addHandler(forms[i], "submit", unloadHandler);
	},
	...
	dispose: function () {
		...
		Nucleo.Web.BaseAjaxControl.callBaseMethod(this, "dispose");
	}
}

Nucleo.Web.BaseAjaxControl.registerClass('Nucleo.Web.BaseAjaxControl', Sys.UI.Control);
