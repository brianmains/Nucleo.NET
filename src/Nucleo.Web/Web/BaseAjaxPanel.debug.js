...
Nucleo.Web.BaseAjaxPanel = function(associatedElement) {
	Nucleo.Web.BaseAjaxPanel.initializeBase(this, [associatedElement]);
...
Nucleo.Web.BaseAjaxPanel.prototype =
{
	...
	_getInnerElementID: function(partialID) {
		return this.get_element() + "_" + partialID;
	},
	...
	initialize: function() {
		Nucleo.Web.BaseAjaxPanel.callBaseMethod(this, "initialize");
	...
	dispose: function() {
		...
		Nucleo.Web.BaseAjaxPanel.callBaseMethod(this, "dispose");
	}
}

Nucleo.Web.BaseAjaxPanel.registerClass('Nucleo.Web.BaseAjaxPanel', Sys.UI.Control);
