...
{
	public class WebFormsServerUtilityService : IServerUtilityService
	{
#if NET20
...
#if NET20
		public WebFormsServerUtilityService()
			: this(HttpContext.Current) { }

		public WebFormsServerUtilityService(HttpContext context)
		{
			_context = context;
		}
#else
		...
		public WebFormsServerUtilityService(HttpContextBase context)
		{
			_context = context;
		}
