...
{
	public class NucleoScriptControlDescriptor : ScriptControlDescriptor, IDescriptor, IElementDescriptor
	{
		#region " Constructors "

		public NucleoScriptControlDescriptor(string type, string elementID)
			: base(type, elementID) { }
