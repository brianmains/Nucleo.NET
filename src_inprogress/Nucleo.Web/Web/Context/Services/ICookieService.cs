...
{
	/// <summary>
	/// Represents a service for creating or getting cookies from the browser.  Most methods are defined in IServiceDictionary interface.
	/// </summary>
	public interface ICookieService : IServiceDictionary
	{
		/// <summary>
		/// Adds a new cookie.
		/// </summary>
