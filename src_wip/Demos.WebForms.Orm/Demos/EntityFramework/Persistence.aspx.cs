...
namespace Nucleo.Demos.EntityFramework
{
	...
	public class PersistencePresenter : BasePresenter<IPersistenceView>
	{
		...
		private ObjectSetEntityUnitOfWork<Culture> GetUnitOfWork()
		{
			var ctx = ObjectContextHelper.Create<AdventureWorksObjectContext>("AdventureWorksObjectContext", true);
			return new ObjectSetEntityUnitOfWork<Culture>(ctx.Cultures);
		}
