...
namespace Nucleo.Collections
{
	...
	public class ChainableCollection<T> : IEnumerable<T>
	{
		...
		public virtual ChainableCollection<T> Add(T item)
		{
			if (item == null)
		...
		public virtual ChainableCollection<T> Clear()
		{
			this.Items.Clear();
			return this;
		}
		...
		public virtual ChainableCollection<T> Contains(T item, out bool result)
		{
		...
		/// <returns>The list of items.</returns>
		public virtual ChainableCollection<T> CopyTo(T[] array)
		{
		...
		/// <returns>The list of items.</returns>
		public virtual ChainableCollection<T> CopyTo(T[] array, int arrayIndex)
		{
		...
		public virtual ChainableCollection<T> Remove(T item)
		{
			if (item == null)
				throw new ArgumentNullException("item");
		...
		/// <returns>The collection of items with the item removed.</returns>
		public virtual ChainableCollection<T> Remove(T item, out bool wasRemoved)
		{
			if (item == null)
				throw new ArgumentNullException("item");
