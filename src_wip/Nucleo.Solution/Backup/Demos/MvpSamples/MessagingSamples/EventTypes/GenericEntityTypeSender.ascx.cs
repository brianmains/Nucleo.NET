...
{
	public interface IGenericEntityTypeSenderView : IView
	{
	...
	public class GenericEntityTypeSenderPresenter : BaseWebPresenter<IGenericEntityTypeSenderView>
	{
		public GenericEntityTypeSenderPresenter(IGenericEntityTypeSenderView view)
			: base(view)
		{
		...
		void View_Clicked(object sender, DataEventArgs<string> e)
		{
			this.CurrentContext.EventRegistry.Publish(new PublishedEventDetails(this,
				ListenerCriterion.EntityType<EntityTargetType>(), new Dictionary<string, object>
				{
					{ "Message", e.Data }
				}));
		}
	...
	[PresenterBinding(typeof(GenericEntityTypeSenderPresenter))]
	public partial class GenericEntityTypeSender : DemoViewUserControl, IGenericEntityTypeSenderView
	{
