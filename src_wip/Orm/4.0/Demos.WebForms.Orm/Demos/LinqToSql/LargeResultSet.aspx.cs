...
using Nucleo.Code.Data.DataClasses;


namespace Nucleo.Demos.LinqToSql
{
	...
	public class LargeResultSetPresenter : BasePresenter<ILargeResultSetView>
	{
		...
		{
			var context = new AdventureWorksDataContext("AdventureWorksDbContext");
			var uow = new TableEntityUnitOfWork<SalesOrderDetail>(context.SalesOrderDetails);
	...
	public partial class LargeResultSet : DemoViewPage<LargeResultSetModel>, ILargeResultSetView
	{
		...
		protected override void OnPreRender(EventArgs e)
		{
			...
			this.gvw.DataSource = this.Model.SalesOrderDetails.ToList();
			this.gvw.DataBind();
		}
