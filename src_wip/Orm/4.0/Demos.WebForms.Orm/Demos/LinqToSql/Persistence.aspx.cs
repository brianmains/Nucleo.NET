...
namespace Nucleo.Demos.LinqToSql
{
	...
	public class PersistencePresenter : BasePresenter<IPersistenceView>
	{
		...
		private TableEntityUnitOfWork<Culture> GetUnitOfWork()
		{
			var ctx = DataContextHelper.Create<AdventureWorksDataContext>("AdventureWorksObjectContext", true);
			return new TableEntityUnitOfWork<Culture>(ctx.Cultures);
		}
