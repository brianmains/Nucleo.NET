...
namespace Nucleo.Collections
{
	...
	public class TypeRegistryTest
	{
		...
		[TestMethod]
		public void GettingMismatchedGenericTypeReturnsNull()
		{
		...
		[TestMethod]
		public void GettingMismatchedTypeReturnsNull()
		{
			var reg = new TypeRegistry();
		...
		[TestMethod]
		public void RegisteringTwoTypesOfSameReturnsFalseForSecond()
		{
			var reg = new TypeRegistry();

			reg.Register(typeof(ITestClass), new TestClass());
			var output = reg.Register(typeof(ITestClass), new TestClass());
